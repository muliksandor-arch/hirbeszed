(function(){
  ...
  function androidAutoPreview(article){
    return '<div class="auto-preview-frame"><div class="auto-aa">'+
      ...
      '<div class="auto-side"><div>Most szól<small>rövid hírösszefoglaló</small></div><div>Következő<small>friss hírek listája</small></div><div>Hang<small>következő, kedvelés, állj</small></div></div>'+
      '</div></div>';
  }
  ...
  function carPlayPreview(article){
    return '<div class="auto-preview-frame"><div class="auto-cp">'+
      ...
      '<div class="auto-stack"><div class="auto-card"><strong>Kedvelés</strong><small>későbbre</small></div><div class="auto-card"><strong>Források</strong><small>mobilon kezelve</small></div></div></div>'+
      '</div></div>';
  }
  ...
  function differenceRows(){
    return '<div class="settings-group auto-diff-list">'+
      ...
      '<div class="settings-row static-row"><span class="row-icon">=</span><span class="row-copy"><strong>Közös terméklogika</strong><small>hír felolvasása, következő, kedvelés, hangutasítás</small></span></div>'+
      '</div>';
  }
